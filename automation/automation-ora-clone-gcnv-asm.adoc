...
NOTE: Stellen Sie sicher, dass der Konfigurationsparameter asm_diskstring auf dem DB-Klonhost alle NFS-Mount-Punkte und Verzeichnispfade der geklonten Volumes zu den Festplattengeräten enthält.
