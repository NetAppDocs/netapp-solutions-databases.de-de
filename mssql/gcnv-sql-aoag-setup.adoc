...
----
+
Detaillierte Informationen zu den Firewall-Anforderungen finden Sie unter link:https://learn.microsoft.com/en-us/troubleshoot/windows-server/networking/service-overview-and-network-port-requirements["Anforderungen an Windows Server-Dienste und Netzwerkports"^].
